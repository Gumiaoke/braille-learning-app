...
export default function ParentCenter() {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 max-w-md mx-auto w-full">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button key={i} className="btn-glass p-4 rounded-3xl flex flex-col items-center gap-2 transition-all">
