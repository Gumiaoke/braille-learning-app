...
import { ChevronLeft, Send, Lightbulb, Book, PenTool, Heart, Mic } from 'lucide-react';
...
export default function AICompanion() {
  ...
  return (
    <div className="h-full flex flex-col bg-white max-w-md mx-auto w-full">
      {/* Header / IP Character */}
      <header className="bg-gradient-to-b from-brand-blue/20 to-white p-6 flex flex-col items-center gap-4 relative">
        <button onClick={() => navigate(-1)} className="absolute left-4 top-4 w-10 h-10 rounded-full bg-white/80 shadow-sm border border-gray-100 flex items-center justify-center text-gray-500 active:scale-95 transition-transform">
          <ChevronLeft size={20} />
        </button>
        <DolphinAvatar size="lg" expression="happy" />
        <div className="text-center">
          <h1 className="text-xl font-black text-gray-800">点点</h1>
        ...
        {messages.map((msg) => (
          ...
          >
            <div className={cn(
              ...
              {msg.type === 'ai' ? <img src="./assets/images/IP形象.png" alt="点点" className="w-full h-full object-contain" /> : <img src="./assets/images/avatar/微信图片_20260604182405_181_99.png" alt="我" className="w-full h-full object-cover rounded-full" />}
            </div>
            <div className={cn(
