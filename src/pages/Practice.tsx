...
import { Mic, Type, FileText, Trophy, ChevronRight, Star, Play } from 'lucide-react';
...
export default function Practice() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-md mx-auto">
      <header>
        <h1 className="text-2xl font-black text-gray-800">练习中心</h1>
        <p className="text-gray-500 text-sm mt-1">多练多学，你是最棒的！</p>
      </header>
      ...
      <div className="grid grid-cols-1 gap-4">
        {modes.map(mode => (
          <button
            ...
            className="bg-white p-5 rounded-3xl shadow-sm border border-gray-100 flex items-center gap-4 text-left active:scale-[0.98] transition-all"
          >
